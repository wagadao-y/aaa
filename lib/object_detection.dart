...
class ObjectDetection {
  ...
  static const String _modelPath = 'assets/models/yolox_nano_float16_quantize.tflite';
  ...
  Uint8List analyseImage(String imagePath) {
    ...
    // Creating matrix representation, [3, 416, 416]
    final imageMatrix = List.generate(
  ...
  List<List<Object>> _runInference(
    ...
    //   3: [0.0],
    // };
    final output = {0:[List<List<num>>.filled(3549, List<num>.filled(85, 0))]};
